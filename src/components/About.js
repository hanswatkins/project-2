        ...
        <div className='image-container-about'>
          <div className='bio-container-about'>
            <img
              src={pianoPic}
              className='piano-pic'
              alt='my hands on a piano keyboard close-up'
            ></img>
            <br></br>
            <br></br>
            ...
            <p class='about-paragraph'>
              ...
              Engineering. In June I enrolled in General Assembly's Software
              Engineering Immersive and I'll be graduating with over 500 hours
              of engineering experience in August 2022.
            </p>
